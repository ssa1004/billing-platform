...
plugins {
    ...
    // /v3/api-docs 를 fetch 해 docs/openapi/billing-platform.yaml 로 떨어뜨린다.
...
// OpenAPI spec export 설정 — ./gradlew :billing-bootstrap:generateOpenApiDocs.
...
openApi {
    ...
    outputFileName.set("billing-platform.yaml")
