 ...
 *
 * <p>대부분의 query path 는 4가지로 압축됨:
 * <ol>
 *   <li>한 객체에 무슨 일이 있었나 (Invoice / Refund / Wallet 의 timeline)</li>
 *   <li>한 actor 가 무슨 행위를 했나 (운영자 활동 추적 / 비정상 패턴 검사)</li>
 *   <li>한 요청의 모든 audit (분산 추적 join — 한 traceId 의 흐름)</li>
 *   <li>특정 action 의 시간 구간 (예: 모든 환불 / 운영자 export 검사)</li>
 * </ol>
 */
public interface AuditQueryUseCase {
    ...
    List<AuditEntry> findByAction(AuditAction action, Instant from, Instant to, int limit);
}
