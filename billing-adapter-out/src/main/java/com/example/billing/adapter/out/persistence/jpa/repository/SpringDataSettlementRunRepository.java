...
public interface SpringDataSettlementRunRepository extends JpaRepository<SettlementRunJpaEntity, UUID> {

    List<SettlementRunJpaEntity> findByPeriodYearMonth(String periodYearMonth);
