...
/**
 * Aged receivables 조회 — [SpringDataInvoiceRepository] 가 추가로 implement.
 *
 * 별도 interface 로 둔 이유: aged 조회는 read-only + 운영 화면용이라 main repository
 * 와 책임을 분리. mixin 형태로 합칠 수 있음.
 */
interface SpringDataInvoiceRepositoryAged {
    ...
    fun findUnpaidAsOf(
        @Param("unpaid") unpaid: List<InvoiceStatus>,
        pageable: Pageable,
