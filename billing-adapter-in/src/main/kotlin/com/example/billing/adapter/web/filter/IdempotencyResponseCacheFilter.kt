...
/**
 * Stripe / 토스페이먼츠 식 *Idempotency-Key 응답 캐싱* + *body fingerprint 검증* 필터.
 *
 ...
 *   <li>저장된 fingerprint 가 있고 *다른 값* 이면 422 INCOMPATIBLE_PARAMS — Stripe 식 client bug
 *       검출 (같은 멱등 키로 다른 body, 잠재적 결제 사고).</li>
...
class IdempotencyResponseCacheFilter(
    ...
    override fun doFilterInternal(req: HttpServletRequest, res: HttpServletResponse, chain: FilterChain) {
        ...
        // 1. 같은 키로 *다른 body* 가 들어왔는지 검출 — Stripe 식 422.
        if (fingerprint != null) {
